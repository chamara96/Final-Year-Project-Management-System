...
<script>
    $(function(){
        $('.am-btn-group>a.am-btn-default').after('<a href="<?= $label->url(GROUP.'-Project-analyze', ['back_url' => base64_encode($_SERVER['REQUEST_URI'])]) ?>" class="am-btn am-btn-success"><span class="am-icon-bar-chart"></span> Project data analysis</a>')
    })
</script>
