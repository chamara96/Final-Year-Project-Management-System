<form action="" class="ajax-submit" method="POST" data-am-validator>
    ...
    <div class="am-input-group am-margin-bottom">
        ...
        <input type="email" name="mail" class="am-form-field" placeholder="email address" required="required">
    </div>
    ...
    <button class="am-btn am-radius am-btn-primary am-btn-block am-margin-bottom">submit</button>
    <a href="<?= $label->url('Team-Login-index'); ?>" class="am-text-sm am-text-danger"><<Back to login</a>
</form>
