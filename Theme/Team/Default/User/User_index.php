...
<script>
    $(function(){
        $('.am-btn-group>a.am-btn-default').after('<a href="<?= $label->url(GROUP.'-User-analyze', ['back_url' => base64_encode($_SERVER['REQUEST_URI'])]) ?>" class="am-btn am-btn-success"><span class="am-icon-bar-chart"></span> User data analysis</a>')
    })
</script>
