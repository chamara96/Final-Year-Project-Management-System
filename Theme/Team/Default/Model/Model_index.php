    ...
    <div class="am-u-sm-12 am-u-md-6 am-padding-top-xs">
        <div class="am-btn-toolbar">
            <div class="am-btn-group am-btn-group-xs">
                ...
                <a href="<?= $addUrl ?>" class="am-btn am-radius am-btn-default"><span class="am-icon-plus"></span> Add</a>
                <a href="<?= $label->url(GROUP . '-' . MODULE . '-import', array('back_url' => base64_encode($_SERVER['REQUEST_URI']))) ?>" class="am-btn am-btn-success"><span class="am-icon-cloud-download"></span> Import model</a>
            </div>
        </div>
    </div>
