<header class="am-topbar am-topbar-inverse">
    <h1 class="am-topbar-brand">
        <a href="<?= $label->url(empty(\Core\Func\CoreFunc::session()->get('team')['user_home']) ? 'Team-Index-index' : \Core\Func\CoreFunc::session()->get('team')['user_home']); ?>"><i class="am-icon-home am-icon-sm"></i> &nbsp; Final Year Project Team
        </a>
    </h1>

    <button class="am-topbar-btn am-topbar-toggle am-btn am-btn-sm am-btn-success am-show-sm-only"
            data-am-collapse="{target: '#doc-topbar-collapse'}">
        <span class="am-sr-only">Navigation switch</span> <span class="am-icon-bars"></span></button>
