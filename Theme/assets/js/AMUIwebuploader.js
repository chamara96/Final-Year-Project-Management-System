    ...
    $.webuploaderConfig = function(api){
        ...
        $.webuploader_for_amazeui = function (param) {
                ...
                uploader.makeThumb(file, function (error, src) {
                    ...
                    if (error) {
                        ...
                        var $li =
                            '<div class="am-gallery-item webuploader-item am-img-thumbnail">' +
                            '<a href="javascript:;" >' +
                            '<img src="' + src + '"  alt="Click to upload picture"/>' +
                            '<h3 class="am-gallery-title am-text-center am-hide"></h3>' +
                            '</a>' +
                            '</div>'
                    }
            ...
            uploader.on('uploadError', function (file, reason) {
                $('#' + file.id + ' h3.am-gallery-title').html('upload failed').removeClass('am-hide');
            });
...
var AMUIwebuploader = {
    ...
    append:function(param){
        ...
        if(param.type == 'file'){
            ...
            var icon =
                '<a href="javascript:;" >' +
                '<img src="' + param.src + '"  alt="Click to upload picture"/>' +
                '<h3 class="am-gallery-title am-text-center am-hide"></h3>' +
                '</a>';
        }
